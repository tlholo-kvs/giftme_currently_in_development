...
class ReviewDonations extends StatefulWidget {
  _ReviewDonationsState createState() => _ReviewDonationsState();
}

class _ReviewDonationsState extends State<ReviewDonations> {
                                    ...
                                    return ListTile(
                                      onTap: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (context) => ViewItem(title: title,description: description,time: time,)),
                                        );
                                      },
                                      title: Text(title),
                                      subtitle: Text('$time'),
